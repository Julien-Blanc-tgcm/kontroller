...
<context>
    ...
    <message>
        ...
        <translation>Для обнаружения новых зон запустите сканирование и затем переключите вывод в Kodi. Зоны будут добавляться автоматически. Не забудьте потом вернуться назад и сохранить результат.</translation>
    </message>
</context>
<context>
